...
_vehicletype = RIPPATROLHARDVEHICLES select floor(random count RIPPATROLHARDVEHICLES);
...
{
    _x addEventHandler ["Killed", {_this spawn RIP_fnc_MPKilledEH}];
    RIPMISSIONGUARDMENS pushBack _x;
    _x setRank "SERGEANT";
} forEach _crew;
